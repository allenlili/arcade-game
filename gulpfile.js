...
var errHandler = function (type, err) {
...
// default
gulp.task('default', ['clean', 'htmls', 'styles', 'scripts', 'images'], function(){
    console.log("starting tasks .clean.htmls.styles.scripts.images");
});
...
gulp.task('watch', function(){
    ...
    return gulp.watch(
        [
            ...
            IMAGES_PATH,
            'gulpfile.js'
        ], undefined, ['htmls', 'styles', 'scripts', 'images']).on('change', browserSync.reload);
});
...
ghpages.publish('dist', {src: './dist'}, function(err) {
    console.log(err);
});